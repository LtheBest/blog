<div class="masonry">
    ...
    <article class="masonry__brick entry format-standard animate-this">
        ...
        <div class="entry__thumb">
            <a href="descriptions/article-<?php echo $response->id ?>-<?php echo slug($response->title) ?>.html" class="entry__thumb-link">
        ...
        <div class="entry__text">
            <div class="entry__header">
                ...
                <h2 class="entry__title"><a href="descriptions/article-<?php echo $response->id ?>-<?php echo slug($response->title) ?>.html"><?php echo $response->title ?></a></h2>
